 ...
 *
 */
open class ItemAdapter(var mcontext: Context, var data: ListInfoEntity,
                       var liveData: MutableLiveData<ListInfoEntity>) :
    RecyclerView.Adapter<ItemAdapter.TestViewHolder>() {
